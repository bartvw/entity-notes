...
Defines how the plugin generates Obsidian Bases `.base` files for configured entity types, giving users a ready-made structured view of their entities without manual authoring.
